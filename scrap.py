...
async def get_consejales() -> List[Consejal]:
...
async def get_ordenes_dia(limit: int = 10, start: int = 1) -> List[OrdenDia]:
...
async def get_orden_dia(id: int) -> Optional[OrdenDia]:
    ordenes = await get_ordenes_dia()
